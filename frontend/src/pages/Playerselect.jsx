...
style={{
        backgroundImage:
          "url('../src/assets/MewTwo punches Ash.png')",
    ...
    {/* <img src="../src/assets/ash-pokemon.png" alt="splash images " /> */}
            ...
            <div className="">
              <p className="text-2xl mt-10 mb-4 text-center">Choose your trainer:</p>
              ...
              {trainers?.map((trainer) => (
                ...
                <ul className="" key={trainer}>
                  <li className="text-white bg-blue-500 hover:bg-blue-600 font-bold py-2 px-4 text-center">
                    <Link to={`/pokemon`}>
                    <button key={trainer} onClick={selectPlayer}>{trainer}</button>
                    </Link>
                  </li>
                </ul>
                </div>
